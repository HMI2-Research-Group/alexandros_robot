...
class MoveGroup(object):
    ...
    def add_box(self, timeout=4, xpos=0.0, ypos=0.0, zpos=0.0):
        ...
        box_name = "box"
        self.scene.add_box(box_name, box_pose, size=(0.12, 0.12, 0.12))
...
def main():
    ...
    try:
        ...
        environment.add_box(xpos=0.2, ypos=0.2, zpos=0.0587375 / 2)
